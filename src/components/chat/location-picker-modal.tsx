...
export function LocationPickerModal({ onClose, onSendLocation }: LocationPickerModalProps) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-sm overflow-hidden rounded-t-3xl sm:rounded-3xl border-t sm:border border-border bg-card shadow-2xl animate-in slide-in-from-bottom-6 duration-200 sm:animate-scale-in pb-[max(1rem,env(safe-area-inset-bottom))] sm:pb-0"
